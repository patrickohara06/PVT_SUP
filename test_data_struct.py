...
if __name__ == "__main__":
    ...
    website_to_test = "https://world.taobao.com/?"
    seleniumsselector_list = ["partial link text;反馈","partial link text;账户无法登录",] # "refresh_sens:id;guide-icon", "relies_prev:partial link text;Trending",
