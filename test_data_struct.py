...
if __name__ == "__main__":
    ...
    website_to_test = "https://www.amazon.com/"
    seleniumsselector_list = ["partial link text;Careers","partial link text;Job Categories",] # "refresh_sens:id;guide-icon", "relies_prev:partial link text;Trending",
